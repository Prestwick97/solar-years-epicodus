...
export class PlanetaryYears {
  ...
  expectancyRemainder() {
    if(this.planetAge > this.planetExpectancy){
      ...
      return "Congratulations! You've survived " + this.planetExcess + " years past your life expectancy on this planet!";
    } else {
      this.planetRemainder = this.planetExpectancy - this.planetAge;
      return "You have " + this.planetRemainder + " years left to live on this planet!";
    }
  };
